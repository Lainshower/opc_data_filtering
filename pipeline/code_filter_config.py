...
text_filter_config['zh'] = {
    ...
    'qsc_doc_entropy_unigram': 'lambda x: x < 2',
    ...
    'qsc_doc_frac_chars_dupe_6grams': 'lambda x: x > 0.90',
    'qsc_doc_frac_chars_dupe_7grams': 'lambda x: x > 0.90',
    'qsc_doc_frac_chars_dupe_8grams': 'lambda x: x > 0.90',
    'qsc_doc_frac_chars_dupe_9grams': 'lambda x: x > 0.90',
    'qsc_doc_frac_chars_dupe_10grams': 'lambda x: x > 0.75',
    'qsc_doc_frac_chars_dupe_lines': 'lambda x: x > 0.80',
    'qsc_doc_frac_lines_dupe_lines': 'lambda x: x > 0.80',
...
text_filter_config['en'] = {
    ...
    'qsc_doc_frac_chars_top_3grams': 'lambda x: x > 0.18',
    'qsc_doc_frac_chars_top_4grams': 'lambda x: x > 0.16',
    'qsc_doc_frac_chars_dupe_5grams': 'lambda x: x > 0.90',
    'qsc_doc_frac_chars_dupe_6grams': 'lambda x: x > 0.90',
    'qsc_doc_frac_chars_dupe_7grams': 'lambda x: x > 0.90',
    'qsc_doc_frac_chars_dupe_8grams': 'lambda x: x > 0.90',
    'qsc_doc_frac_chars_dupe_9grams': 'lambda x: x > 0.90',
    ...
    'qsc_doc_frac_words_redpajama_stop': None,
    'qsc_doc_frac_words_unique': None,
    'qsc_doc_mean_word_length': 'lambda x: x < 3 or x > 20',
    'qsc_doc_num_chars': 'lambda x: x < 50',
    'qsc_doc_num_lines': 'lambda x: x < 5',
    'qsc_doc_num_sentences': 'lambda x: x == 1',
    'qsc_doc_num_words': 'lambda x: x < 10',
...
code_filter_config['data'] = {
    ...
    'qsc_code_num_chars': 'lambda x : x < 10 or x > 2000000',
